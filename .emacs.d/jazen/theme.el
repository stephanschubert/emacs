...
(defun color-theme-jazen ()
  "Color theme by Stephan 'jazen' Schubert, 2009"
  (interactive)
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (font-lock-constant-face ((t (:foreground "#e7c891"))))
     (font-lock-doc-face ((t (:foreground "light sky blue"))))
     (font-lock-doc-string-face ((t (:foreground "sky blue"))))
     (font-lock-function-name-face ((t (:bold t :foreground "#79d8ff" :weight bold))))
     (font-lock-keyword-face ((t (:bold t :foreground "#a6ff9f" :weight bold))))
     (font-lock-reference-face ((t (:foreground "pale green"))))
     (font-lock-string-face ((t (:foreground "#ff81b3" :background "#402b35"))))
     (font-lock-type-face ((t (:bold t :foreground "#f07df7" :weight bold))))
     (font-lock-variable-name-face ((t (:bold t :foreground "#9ffffe" :weight bold))))
     (font-lock-warning-face ((t (:bold t :foreground "Red" :weight bold))))


     (ruby-string-interpolation-begin-face ((t (:foreground "#999999" :background "#333333"))))
     (ruby-string-interpolation-expression-face ((t (:foreground "#ffffff" :background "#333333"))))
     (ruby-string-interpolation-end-face ((t (:foreground "#999999" :background "#333333"))))

     (ruby-method-call-dot-face ((t (:foreground "#ffffff"))))
     (ruby-method-call-name-face ((t (:foreground "#ffffff"))))

     (ruby-regexp-begin-face ((t (:foreground "#e246fe" :background "#3c2649"))))
     (ruby-regexp-face ((t (:foreground "#d790ff" :background "#3c2649"))))
     (ruby-regexp-end-face ((t (:foreground "#e246fe" :background "#3c2649"))))
