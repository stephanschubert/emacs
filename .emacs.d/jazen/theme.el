...
(defun color-theme-jazen ()
  ...
  (color-theme-install
   '(color-theme-charcoal-black
     ...
     (font-lock-constant-face ((t (:foreground "#e7ba6b"))))
     (font-lock-doc-face ((t (:foreground "light sky blue"))))
     (font-lock-doc-string-face ((t (:foreground "sky blue"))))
     (font-lock-function-name-face ((t (:bold t :foreground "#c2ff87" :weight bold))))
     (font-lock-keyword-face ((t (:bold t :foreground "#7effe2" :weight bold))))
     ...
     (font-lock-variable-name-face ((t (:bold t :foreground "#ffffff" :weight bold))))
     (font-lock-warning-face ((t (:bold t :foreground "Red" :weight bold))))

     (ruby-string-interpolation-begin-face ((t (:foreground "#999999" :background "#402b35"))))
     (ruby-string-interpolation-expression-face ((t (:foreground "#ffffff" :background "#402b35"))))
     (ruby-string-interpolation-end-face ((t (:foreground "#999999" :background "#402b35"))))
