...
(defconst ruby-mode-revision "$Revision: 23129 $"
...
(defcustom ruby-string-interpolation-begin-face 'ruby-string-interpolation-begin-face
  "Face used to highlight the beginning of string interpolation in ruby-mode"
  :type 'face
  :group 'ruby)
 
(defcustom ruby-string-interpolation-end-face 'ruby-string-interpolation-end-face
  "Face used to highlight the end of string interpolation in ruby-mode"
  :type 'face
  :group 'ruby)

(defcustom ruby-string-interpolation-expression-face 'ruby-string-interpolation-expression-face
  "Face used to highlight the expression for string interpolation in ruby-mode"
  :type 'face
  :group 'ruby)
